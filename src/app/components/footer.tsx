        ...
        <footer className="bg-black text-white py-8 sm:py-16">
            <div className="container mx-auto flex flex-col sm:flex-row justify-between items-center sm:items-start px-4 sm:px-8 space-y-8 sm:space-y-0">
                ...
                <p className="text-gray-400 mb-3 text-sm sm:text-base leading-relaxed">
                    Promovemos a redução do consumo de energia com práticas sustentáveis, investindo no armazenamento de energia renovável e fornecendo acesso à energia para comunidades carentes. Nosso compromisso inclui a redução de emissões de carbono, contribuindo para um futuro mais sustentável.
                </p>
                <p className="text-gray-500 text-sm sm:text-base mt-4">© 2024 ECOsentry</p>
                </div>
